                                        ...
                                        <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                                            <form class="row g-3 needs-validation" novalidate>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="email" class="form-control h-55 ps-5" id="validationCustom03" value="trz@mail.com" required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
...
<div>        &lt;div class="position-relative"&gt;</div>
<div>            &lt;input type="email" class="form-control h-55 ps-5" id="validationCustom03" value="trz@mail.com" required&gt;</div>
<div>            &lt;div class="valid-feedback"&gt;</div>
<div>                Looks good!</div>
<div>            &lt;/div&gt;</div>
                                        ...
                                        <div class="tab-pane fade show active" id="preview2-tab-pane" role="tabpanel" aria-labelledby="preview2-tab" tabindex="0">
                                            <form class="row g-3 needs-validation" novalidate>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="email" class="form-control h-55" id="validationCustom12" value="trz@mail.com" required>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
...
<div>        &lt;div class="position-relative"&gt;</div>
<div>            &lt;input type="email" class="form-control h-55" id="validationCustom12" value="trz@mail.com" required&gt;</div>
<div>            &lt;div class="valid-feedback"&gt;</div>
<div>                Looks good!</div>
<div>            &lt;/div&gt;</div>
<div>        &lt;/div&gt;</div>
