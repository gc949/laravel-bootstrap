...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Trz - Laravel Admin Dashboard Template</title>
        <!-- Styles -->
    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
                ...
                <div class="masonrow">
					<div class="item">
						<div class="single-testimonials">
							...
							<p>Trz Dashboard Template has transformed how we manage our data. Its intuitive design and customizable features have streamlined our analytics process, enabling us to make informed decisions faster than ever before.</p>
					...
					<div class="item">
						<div class="single-testimonials">
							...
							<p>As a developer, I appreciate the flexibility and robustness of Trz Dashboard Template. It offers a wide range of features that cater to our diverse needs, and its clean codebase has made customization a breeze. Highly recommended!</p>
					...
					<div class="item">
						<div class="single-testimonials">
							...
							<p>Trz Dashboard Template has been a lifesaver for our organization. It's helped us streamline our reporting processes and communicate insights effectively across departments. The time saved has allowed us to focus more on strategic initiatives.</p>
					...
					<div class="item">
						<div class="single-testimonials">
							...
							<p>I can't recommend Trz Dashboard Template enough. It's helped us gain a deeper understanding of our business metrics and identify areas for improvement. The responsive support team is an added bonus, always ready to assist whenever we need it.</p>
					...
					<div class="item">
						<div class="single-testimonials">
							...
							<p>Using Trz Dashboard Template has been a game-changer for our team. The ability to customize widgets to suit our specific needs has allowed us to gain deeper insights into our performance metrics and drive business growth.</p>
					...
					<div class="item">
						<div class="single-testimonials">
							...
							<p>As a startup, we needed a dashboard solution that was both powerful and cost-effective. Trz Dashboard Template checked all the boxes for us. It's helped us stay agile and competitive in a fast-paced market.</p>
                    ...
                    <div class="accordion-item mb-3 border-0 bg-white">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <p>Trz is a comprehensive project management software designed to help teams streamline their workflow, collaborate effectively, and achieve project success.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item mb-3 border-0 bg-white">
                ...
                <div class="border-bottom pb-150">
                    <div class="row">
                        <div class="unlock-content">
                            ...
                            <p>Experience the difference with Trz Dashboard. Sign up for a free trial today and see how our intuitive platform can revolutionize your data analysis process.</p>
        ...
        <div class="copyright-area bg-white text-center py-4">
            <div class="container">
                <p class="fs-14">© <span class="text-primary-div">Trz</span> is Proudly Owned by <a href="https://envytheme.com/" target="_blank" class="text-decoration-none text-primary">EnvyTheme</a></p>
            </div>
        </div>
        <!-- End CopyRight Area -->
