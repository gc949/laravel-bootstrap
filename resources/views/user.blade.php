                                    ...
                                    <table class="table align-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>rebecca@mail.com</td>
                                                <td class="text-body">QA Tester</td>
                                                <td class="text-body">
                                                    <span class="text-truncate d-inline-block" style="width: 200px;">Product Development, Trz Dashboard</span>
                                                </td>
                                                <td>
                                                    <span class="badge bg-danger bg-opacity-10 text-danger p-2 fs-12 fw-normal">Deactive</span>
                                                </td>
