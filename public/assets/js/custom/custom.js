(function () {
    ...
    if (getSwitchToggleId) {
        ...
        const savedTheme = localStorage.getItem("trz_theme");
        if (savedTheme) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (document.body.getAttribute("data-theme") === "dark") {
                ...
                localStorage.setItem("trz_theme", "light");
            } else {
                document.body.setAttribute("data-theme", "dark");
                localStorage.setItem("trz_theme", "dark");
            }
        });
    }
    ...
    if (getSidebarToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                ...
                localStorage.setItem("trz_theme", "sidebar-light");
            } else {
                document.body.setAttribute(
                    "sidebar-dark-light-data-theme",
                    "sidebar-dark"
                );
                localStorage.setItem("trz_theme", "sidebar-dark");
            }
        });
    }
    ...
    if (getHeaderToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                ...
                localStorage.setItem("trz_theme", "header-light");
            } else {
                document.body.setAttribute(
                    "header-dark-light-data-theme",
                    "header-dark"
                );
                localStorage.setItem("trz_theme", "header-dark");
            }
        });
    }
    ...
    if (getFooterToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                ...
                localStorage.setItem("trz_theme", "footer-light");
            } else {
                document.body.setAttribute(
                    "footer-dark-light-data-theme",
                    "footer-dark"
                );
                localStorage.setItem("trz_theme", "footer-dark");
            }
        });
    }
    ...
    if (getRadiusSquaresToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                ...
                localStorage.setItem("trz_theme", "card-radius");
            } else {
                document.body.setAttribute(
                    "card-radius-square-data-theme",
                    "card-square"
                );
                localStorage.setItem("trz_theme", "card-square");
            }
        });
    }
    ...
    if (getCardBgToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                ...
                localStorage.setItem("trz_theme", "card-bg-gray");
            } else {
                document.body.setAttribute(
                    "card-bg-data-theme",
                    "card-bg-normal"
                );
                localStorage.setItem("trz_theme", "card-bg-normal");
            }
        });
    }
    ...
    if (getBoxedToggleId) {
        ...
        switchtoggle.addEventListener("click", function () {
            if (
                ...
                localStorage.setItem("trz_theme", "boxed-style-boxed");
            } else {
                document.body.setAttribute(
                    "boxed-style-data-theme",
                    "boxed-style-fluid"
                );
                localStorage.setItem("trz_theme", "boxed-style-fluid");
            }
        });
    }
...
try {
    ...
    function setTheme(themeName) {
        localStorage.setItem("trz_rtl", themeName);
        document.documentElement.className = themeName;
    }
    // function to toggle between light and dark theme
    function toggleTheme() {
        if (localStorage.getItem("trz_rtl") === "rtl") {
            setTheme("ltr");
        } else {
            setTheme("rtl");
        }
